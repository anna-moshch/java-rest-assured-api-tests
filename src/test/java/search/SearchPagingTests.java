...
import static rijksmuseum.testData.search.SearchParamTestsData.getParamPsMoreThanAllowed;
...
public class SearchPagingTests {
    ...
    public void verifyMaximumPageParam () {
        List<ArtObjectsItem> artObjects = SearchSteps.getArtObjectItems(Culture.NL, SearchParamTestsData.getParamPagingMax());
    ...
    public void verifyingPsParamMoreThanAllowed() {
        List<ArtObjectsItem> artObjects = SearchSteps.getArtObjectItems(Culture.EN, SearchParamTestsData.getParamPsMoreThanAllowed());
    ...
    public void verifyPageParamMoreThanAllowed() {
        List<ArtObjectsItem> artObjects = SearchSteps.getArtObjectItems(Culture.NL, SearchParamTestsData.getParamPagingMoreThanAllowed());
    ...
    public void verifyIncorrectPageNumber() {
        List<ArtObjectsItem> artObjects = SearchSteps.getArtObjectItems(Culture.EN, SearchParamTestsData.getParamIncorrectPageNumber());
